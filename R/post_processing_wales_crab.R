...
# save outputs
readr::write_rds(run_success_all2, file = file.path(paste0(getwd(), "/modelconvergencetest_wales_crab.rds")))

# get convergence rates for all scenarios
run_success_all2_summary <- readr::read_rds(run_success_all2, file = file.path(paste0(getwd(), "/modelconvergencetest_wales_crab.rds"))) |> 
