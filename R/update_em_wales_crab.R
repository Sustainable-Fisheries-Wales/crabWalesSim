#' update the estimation model for brown crab in Welsh waters 
#' 
...
update_em <- function(fore_em=fore_em, 
  ...
  ctl_em$size_selex_parms$INIT[3] <- ctl_em$size_selex_parms$INIT[3] * sel_mult1
  ctl_em$size_selex_parms$LO[3] <- ctl_em$size_selex_parms$LO[3] * sel_mult1
  ctl_em$size_selex_parms$HI[3] <- ctl_em$size_selex_parms$HI[3] * sel_mult1 
  ctl_em$size_selex_parms$PHASE[3] <- ctl_em$size_selex_parms$PHASE[3] * sel_phase
  ctl_em$size_selex_parms$INIT[21] <- ctl_em$size_selex_parms$INIT[21] * sel_mult2
  ctl_em$size_selex_parms$LO[21] <- ctl_em$size_selex_parms$LO[21] * sel_mult2
  ctl_em$size_selex_parms$HI[21] <- ctl_em$size_selex_parms$HI[21] * sel_mult2
  ctl_em$size_selex_parms$PHASE[21] <- ctl_em$size_selex_parms$PHASE[21] * sel_phase
  ctl_em$size_selex_parms$INIT[39] <- ctl_em$size_selex_parms$INIT[39] * sel_mult3
  ctl_em$size_selex_parms$LO[39] <- ctl_em$size_selex_parms$LO[39] * sel_mult3
  ctl_em$size_selex_parms$HI[39] <- ctl_em$size_selex_parms$HI[39] * sel_mult3
  ctl_em$size_selex_parms$PHASE[39] <- ctl_em$size_selex_parms$PHASE[39] * sel_phase
