...
#1 13 #_min and max age over which average F will be calculated, with F=Z-M
...
0.0 # ALK tolerance (example 0.0001)
1234 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1625818227
